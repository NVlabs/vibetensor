...
import torch
from cutlass import Boolean, const_expr, Int32, Int8
from cutlass.cute.runtime import from_dlpack
from vibe_attention.block_sparsity import BlockSparseTensors
from vibe_attention.utils import hash_callable, scalar_to_ssa, ssa_to_scalar
...
def compute_block_sparsity(
    ...
    BlockSparseTensors, Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]
]:
    """
