...
import vibe_attention.pipeline as pipeline
import vibe_attention.utils as utils
from cutlass import const_expr, Float32, Int32
from cutlass.cute.nvgpu import cpasync
from vibe_attention import (
    blackwell_helpers as sm100_utils,
    copy_utils,
    mma_sm100_desc as sm100_desc,
)
from vibe_attention.block_info import BlockInfo
from vibe_attention.block_sparse_utils import (
    get_total_block_count,
    handle_block_sparse_empty_tile_correction_sm100,
    produce_block_sparse_loads_sm100,
    softmax_block_sparse_sm100,
)
from vibe_attention.block_sparsity import BlockSparseTensors
from vibe_attention.fast_math import FastDivmod
from vibe_attention.mask import AttentionMask
from vibe_attention.pack_gqa import PackGQA
from vibe_attention.paged_kv import PagedKVManager
from vibe_attention.seqlen_info import SeqlenInfoQK
from vibe_attention.softmax import apply_score_mod_inner, SoftmaxSm100
...
class FlashAttentionForwardSm100:
    ...
    def softmax_loop(
        ...
        while work_tile.is_valid_tile:
            ...
            block_mask_mod = (
                self.mask_mod if const_expr(self.use_block_sparsity) else None
            )
            mask_fn = partial(
