...
from vibe_kernels.gemm.impl.cutedsl_gemm import activation, copy_utils, sm90_utils
...
class GemmActMixin(GemmDefaultEpiMixin):
    ...
    def epi_smem_bytes_per_stage(
        ...
        postact_bytes_per_stage = cute.size(cute.shape(epi_tile)) * (
    ...
    def epilogue(
        ...
        for epi_idx in cutlass.range_constexpr(epi_tile_num):
            ...
            if const_expr(
                copy_C is not None and epi_idx + self.epi_c_stage < epi_tile_num
            ):
                gmem_coord_C = epi_tile_layout.get_hier_coord(
            ...
            tRS_rPostAct = self.epi_visit_subtile(
                params, epi_loop_tensors, tRS_rD, tRS_rC
            )
